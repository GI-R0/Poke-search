  ...
  return (
    <>
      ...
      <nav
        ...
        className="relative z-50 bg-bg-primary text-white"
        ref={navRef}
      >
        <div className="max-w-7xl mx-auto flex items-center px-4 h-[var(--header-height)]">
          ...
          >
            <span
              className={`block w-6 h-[2px] bg-white transform transition-all ${
                open ? "rotate-45 translate-y-1.5" : "-translate-y-1.5"
              }`}
            />
            <span
              className={`block w-6 h-[2px] bg-white my-1 transition-opacity ${
          ...
          <div
            ...
            className="hidden sm:flex items-center gap-5 ml-auto pr-4"
          >
